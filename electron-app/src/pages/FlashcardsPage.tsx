      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 p-3">
        <div className="max-w-4xl mx-auto py-4">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative w-full max-w-2xl h-80 cursor-pointer perspective-1000" onClick={handleFlip}>
              <div
              ...
              >
                ...
                <Card className="absolute inset-0 backface-hidden bg-white shadow-xl hover:shadow-2xl transition-shadow">
                  <CardContent className="h-full flex flex-col justify-center items-center p-6 text-center">
                    <Badge className="mb-4 text-xs">Term</Badge>
                ...
                <Card className="absolute inset-0 backface-hidden rotate-y-180 bg-emerald-50 shadow-xl">
                  <CardContent className="h-full flex flex-col justify-center items-center p-6 text-center">
                    ...
                    <p className="text-lg text-gray-800 leading-relaxed mb-4">{currentFlashcard?.explanation}</p>
          ...
          {/* Navigation - Positioned closer to card */}
          <div className="flex justify-center gap-3 mb-6">
            <Button
              variant="outline"
              onClick={handlePrevious}
              className="h-12 px-6 bg-white shadow-sm hover:shadow-md transition-shadow text-sm font-medium"
          ...
          <div className="text-center max-w-md mx-auto">
            {allCardsStudied ? (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                <h3 className="text-base font-semibold text-green-800 mb-2">🎉 All Cards Studied!</h3>
                <p className="text-sm text-green-700">Click "Start Quiz" above to test your knowledge.</p>
              </div>
            ) : (
              <p className="text-sm text-gray-600 mb-4">Study all cards to unlock the quiz!</p>
            )}
